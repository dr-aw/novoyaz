...
func main() {
	...
	//Список "ключей", по которым режется слово
	var keys = []string{"ник", "щик", "чик", "ова", "ева", "ива", "енн",
		"ка", "чив", "ущ", "ющ", "яч", "оват", "оров", "дны",
		"дно", "дин", "лог", "чес", "щест", "еч", "сно", "сот",
		"изм", "етн", "сти", "тен", "лл"}
...
// Эта функция заменяет "корень" слова на единственно верное
